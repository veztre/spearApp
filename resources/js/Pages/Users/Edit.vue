            ...
            <div class="overflow-hidden ma-8 w-full  bg-red-200 rounded-lg border shadow-xs">
                <div class="overflow-x-auto  mx-8 w-3/4">
                    <form @submit.prevent="update">
                        ...
                        <BreezeInput id="name" v-model="form.first_name" type="text" class="block w-full my-5" />
                        <BreezeLabel class="block w-1/2 mt-5" for="name" value="Last Name" />
                        <BreezeInput id="name" v-model="form.last_name" type="text" class="block w-full my-5" />
                        ...
                        <BreezeInput type="email" v-model="form.email" class="block w-full my-5" required readonly />
                        <div v-if="form.role != 'chancellor'">
                            ...
                            <select name="department" v-model="form.department" class="block w-full my-5 rounded-lg">
                                ...
                                <option selected value="College of Architecture, Fine Arts and Design">
                                ...
                                <option value="College of Informatics and Computing Science">College of Informatics and
