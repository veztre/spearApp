<template>
  ...
  <template #header>
   Comment on Activity Number {{activity_id}}
  </template>
  ...
  <div class="p-4 bg-white rounded-lg shadow-xs">
    <div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md">
      ...
      <div class="px-4 py-2 -mx-3">
        <div class="mx-3">
          <span class="font-semibold text-blue-500">Create Comment</span>
        </div>
      </div>
    </div>
    ...
    <div class="overflow-hidden ma-8 w-full  bg-red-200 rounded-lg border shadow-xs">
      <div class="overflow-x-auto  mx-8 w-3/4">
              <form @submit.prevent="submit">
                 <BreezeLabel class="block w-1/2 mt-5" for="comment" value="Comment"/>
                  <textarea
                      id="name"
